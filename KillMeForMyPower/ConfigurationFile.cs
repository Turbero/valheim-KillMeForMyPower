        ...
        {
            {
                ...
                vendorHaldorBossToKill = config("2 - Config", "VendorHaldorBossToKill", BossNameEnum.Eikthyr, "Boss to be killed before being able to talk to Haldor (default = Eikthyr). Possible values: Eikthyr,TheElder,Bonemass,Moder,Yagluth,Queen,Fader");
                ...
                vendorHildirBossToKill = config("2 - Config", "VendorHildirBossToKill", BossNameEnum.Eikthyr, "Boss to be killed before being able to talk to Haldor (default = Eikthyr). Possible values: Eikthyr,TheElder,Bonemass,Moder,Yagluth,Queen,Fader");
                ...
                vendorBogWitchBossToKill = config("2 - Config", "VendorBogWitchBossToKill", BossNameEnum.TheElder, "Boss to be killed before being able to talk to Haldor (default = TheElder). Possible values: Eikthyr,TheElder,Bonemass,Moder,Yagluth,Queen,Fader");
